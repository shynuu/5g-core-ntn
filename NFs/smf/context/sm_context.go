...
// logger.PduSessLog.Infoln(smContext.PDUSessionID)
// logger.PduSessLog.Infoln(smContext.Snssai)
// logger.PduSessLog.Infoln(smContext.Supi)
// logger.PduSessLog.Infoln(smContext.Tunnel.DataPathPool.GetDefaultPath().FirstDPNode.UpLinkTunnel.TEID)
// logger.PduSessLog.Infoln(smContext.Tunnel.DataPathPool.GetDefaultPath().FirstDPNode.DownLinkTunnel.TEID)
// logger.PduSessLog.Infoln(smContext.BPManager)
// logger.PduSessLog.Infoln(smContext.PDUAddress.To4().String())
// logger.PduSessLog.Infoln(smContext.DnnConfiguration.Var5gQosProfile.Var5qi)
// logger.PduSessLog.Infoln(smContext.DnnConfiguration.Var5gQosProfile.Arp.PriorityLevel)
// logger.PduSessLog.Infoln(smContext.DnnConfiguration.Var5gQosProfile.PriorityLevel)

type SMContext struct {
	SessionInfo *QOFSessionInfo
