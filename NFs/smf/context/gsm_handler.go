...
func (smContext *SMContext) HandlePDUSessionEstablishmentRequest(req *nasMessage.PDUSessionEstablishmentRequest) {
	...
	// logger.GsmLog.Infoln(smContext.PDUSessionID)
	// logger.GsmLog.Infoln(smContext.Snssai)
	// logger.GsmLog.Infoln(smContext.Supi)
	// logger.GsmLog.Infoln(smContext.LocalSEID)
	// logger.GsmLog.Infoln(smContext.RemoteSEID)
	// logger.GsmLog.Infoln(smContext.Tunnel)
	// logger.GsmLog.Infoln(smContext.BPManager)
	// logger.GsmLog.Infoln(smContext.PDUAddress.To4().String())
	// logger.GsmLog.Infoln(smContext.DnnConfiguration.Var5gQosProfile.Var5qi)
	// logger.GsmLog.Infoln(smContext.DnnConfiguration.Var5gQosProfile.Arp.PriorityLevel)
	// logger.GsmLog.Infoln(smContext.DnnConfiguration.Var5gQosProfile.PriorityLevel)
